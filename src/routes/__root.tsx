...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FinSoko — Fair credit for East Africa's informal traders" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "FinSoko — Fair credit for East Africa's informal traders" },
      {
        ...
        content:
          "Ethical AI lending for informal traders. Built on African data sovereignty, PRIDE human-in-the-loop review, and GUARD risk rails.",
      },
